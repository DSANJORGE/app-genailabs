...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      NI: x0 => x0.getAllResponseHeaders(),
      ...
      TI: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      UI: (x0,x1) => { x0.withCredentials = x1 },
