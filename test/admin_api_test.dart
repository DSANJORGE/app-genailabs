...
void main() {
  ...
  test('createUser posts form fields', () async {
    http.canned['services/testu/personas/createuser.json'] = {
      'ok': true,
      'id': 'x@y.z',
    };
  ...
  test(
    'overview parses series, levels, topics, calibration, teams, gaps, iris',
    () async {
  ...
  test(
    'activity parses hours triples, funnel and inactive lastactivity',
    () async {
  ...
  test(
    'person parses raw lastlogin, extended mastery counters, usage and iris',
    () async {
  ...
  test(
    'ask parses answer, followups and JSON-encodes a map citation value',
    () async {
